        ...
        <div class="main">
           ...
           <div>
                <table>
                    <th id="fontc">공원코스</th>
                    <tr>
                        <td><img src="${root }resources/images/park.png" class="route"></td>
                    </tr>
                </table> 
            </div>    
        </div>
...
<script>
		...
		mapOption = {
			center : new kakao.maps.LatLng(37.569325, 126.902120), // 지도의 중심좌표
			level : 6
		// 지도의 확대 레벨
		};
		...
		// 마우스로 클릭한 위치입니다 
		var a1 = new kakao.maps.LatLng(37.556612, 126.928785);
		var a2 = new kakao.maps.LatLng(37.558304, 126.925950);
		var a3 = new kakao.maps.LatLng(37.56650292654526, 126.91841881305191);
		var a4 = new kakao.maps.LatLng(37.567157744835285, 126.91717426815802);
		var a5 = new kakao.maps.LatLng(37.566009682959006, 126.91417019404996);
		var a6 = new kakao.maps.LatLng(37.56304195897105, 126.9039522012168);
		var a7 = new kakao.maps.LatLng(37.56216940961202, 126.89914600105874);
		var a8 = new kakao.maps.LatLng(37.55915139727044, 126.89182026719274);
		var a9 = new kakao.maps.LatLng(37.5610431879603, 126.88772062676328);
		var a10 = new kakao.maps.LatLng(37.56557410527688, 126.89180344538114);
		var a11 = new kakao.maps.LatLng(37.56901256388669, 126.88715923938041);
		var a12 = new kakao.maps.LatLng(37.56569546534169, 126.89198206868886);
		var a13 = new kakao.maps.LatLng(37.56444140180424, 126.89412554838148);
		...
		function showDistance(content, position) {
			...
			if (distanceOverlay) { // 커스텀오버레이가 생성된 상태이면
				...
				distanceOverlay = new kakao.maps.CustomOverlay({
					...
					position : a13, // 커스텀오버레이를 표시할 위치입니다.
					xAnchor : 0,
					yAnchor : 0,
					zIndex : 3
				});
