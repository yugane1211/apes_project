...
<body>
 <c:set var="url" value="/board/Qnawrite"/>
       <br>
    ...
    <div id="ccc" style="background-color: rgb(234, 170, 0);">
          ...
          <div id="buttons">
          <button id="c6" type="button" onclick="location.href='qna'">뒤로가기</button>
			<button type="button" onclick="location.href='Qnawrite'" style="margin-right:0px">초기화</button>
