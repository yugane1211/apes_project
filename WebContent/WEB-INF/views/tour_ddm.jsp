...
table{position:absolute;bottom:-1%; left:23%;  }
...
<section>
        <div class="main">
           ...
           <div>
                <table>
                    <th id="fontc">동대문코스</th>
                    <tr>
                        <td><img src="${root }resources/images/ddm.png" class="route"></td>
                    </tr>
                </table> 
            </div>    
        </div>
    ...
    <script type="text/javascript"
		...
		mapOption = {
			center : new kakao.maps.LatLng(37.561926, 127.027618), // 지도의 중심좌표
			level : 6
		// 지도의 확대 레벨
		};
		...
		// 마우스로 클릭한 위치입니다 
		var a1 = new kakao.maps.LatLng(37.569908, 127.009354);
		var a2 = new kakao.maps.LatLng(37.569775, 127.002031);
		var a3 = new kakao.maps.LatLng(37.569055, 126.998004);
		var a4 = new kakao.maps.LatLng(37.569964, 126.997868);
		var a5 = new kakao.maps.LatLng(37.568701, 126.997949);
		var a6 = new kakao.maps.LatLng(37.569411, 127.002103);
		var a7 = new kakao.maps.LatLng(37.569617, 127.015871);
		var a8 = new kakao.maps.LatLng(37.571681, 127.021383);
		var a9 = new kakao.maps.LatLng(37.569493, 127.030299);
		var a10 = new kakao.maps.LatLng(37.571906, 127.036893);
		var a11 = new kakao.maps.LatLng(37.571359, 127.041244);
		var a12 = new kakao.maps.LatLng(37.569367, 127.044804);
		var a13 = new kakao.maps.LatLng(37.557065, 127.051187);
		var a14 = new kakao.maps.LatLng(37.554680, 127.048317);
		var a15 = new kakao.maps.LatLng(37.552587, 127.040006);
		var a16 = new kakao.maps.LatLng(37.551048, 127.036557);
		var a17 = new kakao.maps.LatLng(37.546213, 127.030370);
		var a18 = new kakao.maps.LatLng(37.550219, 127.034935);
		...
		function showDistance(content, position) {
			...
			if (distanceOverlay) { // 커스텀오버레이가 생성된 상태이면
				...
				distanceOverlay = new kakao.maps.CustomOverlay({
					...
					position : a18, // 커스텀오버레이를 표시할 위치입니다.
					xAnchor : 0,
					yAnchor : 0,
					zIndex : 3
				});
